(function ($) {
    ...
    $(document).ready(function () {
        ...
        if (typeof iban != 'undefined') {
            $(iban).mask('99 9999 9999 9999 9999 9999 9999', {
        ...
        */
        ...
        $("#apaczka_woocommerce_settings_general_service").change(function (e) {
            validateShippingPointSelected()
        });
        $("#apaczka_woocommerce_settings_general_dispath_point_ups").change(function (e) {
            validateShippingPointSelected();
        });
        $("#apaczka_woocommerce_settings_general_dispath_point_kurier48").change(function (e) {
            validateShippingPointSelected();
        });
        $("#apaczka_woocommerce_settings_general_dispath_point_inpost").change(function (e) {
            validateShippingPointSelected();
        });
        $("#apaczka_woocommerce_settings_general_dispath_point_dpd").change(function (e) {
            validateShippingPointSelected();
        });
    });
