 ...
 * Description: Zarządzaj wysyłkami różnych kurierów w jednym miejscu
...
add_filter(
	...
	function ( $links ) {
		$plugin_links = array(
			'<a href="' . esc_url( admin_url( 'admin.php?page=wc-settings&tab=apaczka_woocommerce_settings_general' ) ) . '">' . esc_html__( 'Ustawienia', 'apaczka-pl' ) . '</a>',
		);
