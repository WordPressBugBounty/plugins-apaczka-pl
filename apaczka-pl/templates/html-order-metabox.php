...
<?php if ( ! $package_send ) : ?>
	...
	<div id="apaczka_panel_sender"
		...
		<h4>
			<?php esc_html_e( 'Sender', 'apaczka-pl' ); ?>
		</h4>
	...
	<div id="apaczka_panel_receiver"
		class="panel woocommerce_options_panel apaczka_panel">
		<h4>
			<?php esc_html_e( 'Receiver', 'apaczka-pl' ); ?>
		</h4>
	...
	<div id="apaczka_panel_properties"
		...
		<h4>
			<?php esc_html_e( 'Package properties', 'apaczka-pl' ); ?>
		</h4>
		...
		<div class="options_group">
			...
			$package_width = ! empty( $apaczka_wc_order_data['package_properties'][ $key ] ) ? $apaczka_wc_order_data['package_properties'][ $key ] : '';
			woocommerce_wp_text_input(
				array(
					'id'                => sprintf(
						'_apaczka[package_properties][%s]',
			...
			$package_depth = ! empty( $apaczka_wc_order_data['package_properties'][ $key ] ) ? $apaczka_wc_order_data['package_properties'][ $key ] : '';
			woocommerce_wp_text_input(
				array(
					'id'                => sprintf(
						'_apaczka[package_properties][%s]',
			...
			$package_height = ! empty( $apaczka_wc_order_data['package_properties'][ $key ] ) ? $apaczka_wc_order_data['package_properties'][ $key ] : '';
			woocommerce_wp_text_input(
				array(
					'id'                => sprintf(
						'_apaczka[package_properties][%s]',
			...
			$package_weight = ! empty( $apaczka_wc_order_data['package_properties'][ $key ] ) ? $apaczka_wc_order_data['package_properties'][ $key ] : '';
			woocommerce_wp_text_input(
				array(
					'id'                => sprintf(
						'_apaczka[package_properties][%s]',
...
<div class="panel woocommerce_options_panel apaczka_panel">
		...
		<div class="apaczka-actions-wrapper">
			...
			<div id="deliver_to_any_shipping_point" style="display:none">
				<p>
					<?php
					echo esc_html__(
						'Deliver the shipment to any shipping point of the selected carrier',
						'apaczka-pl'
					);
					?>
				</p>
			...
			<div class="options_panel-button-wrapper">
				...
				<button disabled class="button-primary apaczka_send"
					...
					<?php esc_html_e( 'Send', 'apaczka-pl' ); ?></button>
			</div>
	...
	<?php if ( $package_send == true ) : ?>
		...
		<h4><?php esc_html_e( 'The waybill number is:', 'apaczka-pl' ); ?>
		...
		<?php if ( $choosed_carrier ) : ?>
			<h4><?php esc_html_e( 'Carrier:', 'apaczka-pl' ); ?>
