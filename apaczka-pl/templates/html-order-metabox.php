            ...
            <div class="apaczka-sender-template-wrapper">
                ...
                if ( ! $package_send ) :
                    woocommerce_wp_select( [
                        ...
                        'label'             => __( 'Sender template',
                            'apaczka-pl' ),
                        'desc_tip'          => false,
                        'type'              => 'number',
                        'options'           => $sender_templates,
                        'value'             => '',
                        'custom_attributes' => [ 'data-raw-id' => 'test' ],
                    ] );
                    ?>
    ...
    <div id="apaczka_panel_properties"
        ...
        <div class="options_group">
            ...
            <div class="apaczka-sender-template-wrapper">
                ...
                woocommerce_wp_select( [
                    'id'                => sprintf( '_apaczka[package_properties][%s]',
                        $key ),
                    'label'             => __( 'Package properties template',
                        'apaczka-pl' ),
                    'desc_tip'          => false,
                ...
                <?php if ( ! $package_send ) : ?>
                    ...
                    <button id="apaczka_load_package_properties_settings_btn"
                        ...
                        <?php _e( 'Get data from selected template',
                            'apaczka-pl' ) ?></button>
                <?php endif; ?>
            ...
            woocommerce_wp_text_input( [
                'id'                => sprintf( '_apaczka[additional_options][%s]',
                    $key ),
                'label'             => __( 'COD amount',
                    'apaczka-pl' ),
                'desc_tip'          => false,
...
<div class="panel woocommerce_options_panel apaczka_panel">
    <?php if ( $package_send == false ) : ?>
        <div class="apaczka-actions-wrapper">
            ...
            <div class="apaczka-hidden" id="apaczka_delivery_point_id_wrapper">
                ...
                woocommerce_wp_text_input( [
                    'id'                => sprintf( '_apaczka[delivery_point_id]',
                        $key ),
                    'label'             => __( 'Delivery point id',
                        'apaczka-pl' ),
                    'desc_tip'          => false,
                    'type'              => 'text',
                    'custom_attributes' => $custom_attributes,
    ...
    <div class="apaczka_error" id="apaczka_error">
        <?php if ( isset( $apaczka_wc_order_data['error_messages'] )
    ...
    <?php if ( $package_send == true ) : ?>
        <?php $srv_list = ( new Service_Structure_Helper() )->get_services();
        $choosed_carrier = '';
        ...
        <h3><?php _e( 'Your order has been placed on apaczka.pl',
                'apaczka-pl' ); ?></h3>
    ...
    <?php if ( $package_send ) : ?>
        ...
        <button
                ...
                id="apaczka_get_waybill"><?php _e( 'Get waybill',
                'apaczka-pl' ); ?></button>
        </a>
        <br/>
        <br/>
        <button class="button-primary apaczka_cancel" id="apaczka_cancel"
                data-apaczka-id="<?php echo esc_attr( $id ); ?>"><?php _e( 'Cancel parcel',
                'apaczka-pl' ); ?></button>
        ...
        <?php if ( $apaczka_wc_order_data['package_properties']['shipping_method'] === 'COURIER' ): ?>
            <button class="button-primary apaczka_download_turn_in"
                    ...
                    data-apaczka-id="<?php echo esc_attr( $id ); ?>"><?php _e( 'Download turn in protocol',
                    'apaczka-pl' ); ?></button>
        <?php endif; ?>
    <?php endif; ?>
...
<script type="text/javascript">
    ...
    jQuery(document).on("click", '#apaczka_get_waybill', function (event) {
        ...
        window.location.href = document.location.toString() + '&apaczka_get_waybill=<?php
